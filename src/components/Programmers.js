...
export default function Programmers() {
  ...
  const [activeP, setId] = useState(null)
  ...
  const getNameOfFeatured = () => {
    ...
    const featuredDev = programmers.find((dev) => dev.id === activeP)
  ...
  const style = {
    fontSize: "1.5em",
    marginTop: "0.5em",
    color: activeP ? "gold" : "royalblue", // 🤔 color turns to gold, when celebrating
  }
